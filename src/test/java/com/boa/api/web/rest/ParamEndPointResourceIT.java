...
import com.boa.api.DemandeCreditApp;
 ...
 */
@SpringBootTest(classes = DemandeCreditApp.class)
public class ParamEndPointResourceIT {
    ...
    public void setup() {
        ...
        final ParamEndPointResource paramEndPointResource = new ParamEndPointResource(paramEndPointService);
        this.restParamEndPointMockMvc = MockMvcBuilders.standaloneSetup(paramEndPointResource)
